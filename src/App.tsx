...
const App = () => {
  ...
  const handleOnDeleteItem = (value: number) => {
    console.log(value);

    // setItemList((prev) => {
    // return prev.filter((item, index) => index != indexs);
    // });
    setItemList((prev) => {
      return prev.filter((item, index) => {
        if (index != value) return item;
      });
    });
  };
              ...
              return (
                !item.done && (
                  <ListItem
                    ...
                    key={`item-${index}`}
                    onChange={(value) => {
                      handleOnChangeItem(index, value);
                    }}
                    onDelete={() => {
              ...
              return (
                item.done && (
                  <ListItem
                    ...
                    key={`item-${index}`}
                    onChange={(value) => {
                      return handleOnChangeItem(index, value);
                    }}
                    onDelete={() => {
                      handleOnDeleteItem(index);
                    }}
